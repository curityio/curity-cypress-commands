...
/**
 * Registers the Curity commands in Cypress.
 *
 * @param commandPrefix Prefix all command names. The resulting command name will have its first letter capitalized. E.g. `getIDToken` becomes `prefixGetIDToken`.
 */
declare function registerCurityCommands(commandPrefix?: string): void
